...
void java_FireLogonResult(long lResult, long lReason, long extraCode)
{
    ...
    LOGI(TAG, "java_FireLogonResult lResult[%ld], lReason[%ld]", lResult, lReason);
...
void java_FireReportMemberStatus(char *lpJID, char *lpCallee, long lStatus, long lCallType)
{
    ...
    LOGI(TAG, "java_FireReportMemberStatus pJID[%s] lpCallee[%s] lResult[%ld], lReason[%ld]", lpJID, lpCallee, lStatus, lCallType);
...
void java_FireSomeOneCallMe(char *lpJID, char *lpCaller, long lType)
{
    ...
    LOGI(TAG, "java_FireSomeOneCallMe lpJID[%s] lpCaller[%s] lType[%ld]", lpJID, lpCaller, lType);
...
void java_FireIMSMessageArrived(int iType, LPCTSTR pChatRoomURI, LPCTSTR pSenderURI, LPCTSTR pMessage, LPCTSTR pTime, LPCTSTR pMessageId, int iReceipt, LPCTSTR pSipTime)
{
    ...
    LOGI(1, "rcscontroller java_FireIMSMessageArrived iType[%d] pChatRoomURI[%s] pSenderURI[%s] pMessage[***] pTime[%s] pMessageId[%s] iReceipt[%d] pSipTime[%s]",
    ...
    if(JNI_ERR == iresult || gJinMethod == 0 || gJinMethod == NULL)
    {      
        LOGE(1, "rcscontroller not found java_FireIMSMessageArrived");
        return;
    }
...
void java_FireIMSGotUserInfo(short far* pNotify)
{
    ...
    LOGI(TAG, "rcscontroller java_FireIMSGotUserInfo end");
}
void java_FireIMSGotGroupInfo(int index, int count, short far* pNotify)
{
    ...
    LOGI("rcscontroller java_FireIMSGotGroupInfo begin, totalNum=%d, index=%d count=%d", pGroupInfo->iNum, index, count);
    ...
    if(JNI_ERR == iresult || gJinMethod == 0 || gJinMethod == NULL)
    {
        LOGE(TAG, "rcscontroller not found java_FireIMSGotGroupInfo");
        return;
    }
    ...
    LOGI(TAG, "rcscontroller java_FireIMSGotGroupInfo over");
}
void java_FireIMSPsEvent(long iType, short far* pNotify)
{
    ...
    if(JNI_ERR == iresult || gJinMethod == 0 || gJinMethod == NULL)
    {
        LOGE(TAG, "not found java_FireIMSPsEvent");
...
void java_FireIMSGotOneRLS(int iResult, LPCTSTR pURI, LPCTSTR pGroupName, LPCTSTR pListName, int iListNum, short far* pListMemberURI)
{
    ...
    if(JNI_ERR == iresult || gJinMethod == 0 || gJinMethod == NULL)
    {
        LOGE(TAG, "not found java_FireIMSGotOneRLS");
...
void java_FireIMSGotMyPresenceRule(long iType, long iNum, short far* pURIList)
{
    ...
    if(JNI_ERR == iresult || gJinMethod == 0 || gJinMethod == NULL)
    {
        LOGE(TAG, "not found java_FireIMSGotMyPresenceRule");
...
void java_FireIMSSendMessageReport(LPCTSTR pReportID, LPCTSTR pReportType, LPCTSTR pDoneTime, LPCTSTR pErrorCode, LPCTSTR pTerminal)
{
    ...
    if(JNI_ERR == iresult || gJinMethod == 0 || gJinMethod == NULL)
    {
        LOGE(TAG, "not found java_FireIMSSendMessageReport");
...
void java_FireIMSListPresenceArrived(LPCTSTR pSipFromURI, LPCTSTR pListURI, LPCTSTR pStatus, LPCTSTR pPhone, long iTimestamp)
{
    ...
    if(JNI_ERR == iresult || gJinMethod == 0 || gJinMethod == NULL)
    {
        LOGE(TAG, "not found java_FireIMSListPresenceArrived");
...
void java_FireIMSGetPublicGroupInfoListFailed(LPCTSTR lpGroupURI, long iResult)
{
    ...
    if(JNI_ERR == iresult || gJinMethod == 0 || gJinMethod == NULL)
    {
        LOGE(TAG, "not found java_FireIMSGetPublicGroupInfoListFailed");
...
void java_FireIMSGotOnePublicGroup(int flag, LPCTSTR pGroupName, LPCTSTR pGroupURI, LPCTSTR pOperUser, long iMyRole, short far* pAttribute, long iMemberNum, void **pMemberList, long iBlacklistNum, short far* pBlacklist)
{
    ...
    LOGI(TAG, "rcscontroller java_FireIMSGotOnePublicGroup begin, flag[%d] pGroupURI[%s] iMemberNum[%d]", flag, pGroupURI, iMemberNum);
    if(iMemberNum > MAX_GROUP_MEMBER_NUM)
    {
        LOGI(TAG, "rcscontroller java_FireIMSGotOnePublicGroup iMemberNum[%d] is abnormal, MAX_GROUP_MEMBER_NUM[%d]", iMemberNum, MAX_GROUP_MEMBER_NUM);
        return;
    }
    ...
    if(JNI_ERR == iresult || gJinMethod == 0 || gJinMethod == NULL)
    {
        LOGE(TAG, "rcscontroller not found java_FireIMSGotOnePublicGroup");
        return;
    }
    if(pAttr == NULL)
    {
        LOGE(TAG, "rcscontroller java_FireIMSGotOnePublicGroup pAttr == NULL");
        return;
    }
    if(iMemberNum > 0 && (pMemberList == NULL))
    {
        LOGE(TAG, "rcscontroller java_FireIMSGotOnePublicGroup pMembers == NULL, iMemberNum=%d", iMemberNum);
        return;
    }
    ...
    LOGI(TAG, "rcscontroller java_FireIMSGotOnePublicGroup end");
}
...
void java_FireIMSModifyPublicGroupResult(LPCTSTR pGroupURI, long iType, LPCTSTR pNewName, long iNewValue, long iResult)
{
    ...
    if(JNI_ERR == iresult || gJinMethod == 0 || gJinMethod == NULL)
    {
        LOGE(TAG, "not found java_FireIMSModifyPublicGroupResult");
        return;
    }
...
void java_FireIMSInviteToMyPuGroupSendResult(LPCTSTR pSomeoneURI, LPCTSTR pDisplayName, LPCTSTR pGroupURI, long iResult)
{
    ...
    if(JNI_ERR == iresult || gJinMethod == 0 || gJinMethod == NULL)
    {
        LOGE(TAG, "not found java_FireIMSInviteToMyPuGroupSendResult");
        return;
    }
...
void java_FireIMSPGroupListPresenceArrived(LPCTSTR pPublicGroupURI, LPCTSTR pListURI, LPCTSTR pStatus, LPCTSTR pPhone)
{
    ...
    LOGE(TAG, "java_FireIMSPGroupListPresenceArrived begin");
    ...
    if(JNI_ERR == iresult || gJinMethod == 0 || gJinMethod == NULL)
    {
        LOGE(TAG, "not found java_FireIMSPGroupListPresenceArrived");
...
void java_FirePublicGroupAttributeChanged(LPCTSTR pURI, long iType, LPCTSTR pName, long iValue)
{
    ...
    if(JNI_ERR == iresult || gJinMethod == 0 || gJinMethod == NULL)
    {
        LOGE(TAG, "not found java_FirePublicGroupAttributeChanged");
...
void java_FireIMSInvitedToPublicGroup(short far* pPara)
{
    ...
    if(JNI_ERR == iresult || gJinMethod == 0 || gJinMethod == NULL)
    {
        LOGE(TAG, "not found java_FireIMSInvitedToPublicGroup");
...
void java_FireIMSInvitedToTmpPublicGroup(short far* pPara)
{
    ...
    if(JNI_ERR == iresult || gJinMethod == 0 || gJinMethod == NULL)
    {
        LOGE(TAG, "not found java_FireIMSInvitedToTmpPublicGroup");
...
void java_FireIMSPublicGroupInviteResult(LPCTSTR pGroupURI, LPCTSTR pInvitedUserURI, long iResult)
{
    ...
    if(JNI_ERR == iresult || gJinMethod == 0 || gJinMethod == NULL)
    {
        LOGE(TAG, "not found java_FireIMSPublicGroupInviteResult");
...
void java_FireIMSSearchPuGroupResult(long iResultNum, LPCTSTR pSearchString, short far* pNotify)
{
    ...
    if(JNI_ERR == iresult || gJinMethod == 0 || gJinMethod == NULL)
    {
        LOGE(TAG, "not found java_FireIMSSearchPuGroupResult");
...
void java_FireIMSSearchPublicGroupFailed(LPCTSTR pGroupURI)
{
    ...
    if(JNI_ERR == iresult || gJinMethod == 0 || gJinMethod == NULL)
    {
        LOGE(TAG, "not found java_FireIMSSearchPublicGroupFailed");
...
void java_FireIMSReqJoinMyPublicGroup(short far* pPara)
{
    ...
    if(JNI_ERR == iresult || gJinMethod == 0 || gJinMethod == NULL)
    {
        LOGE(TAG, "not found java_FireIMSReqJoinMyPublicGroup");
...
void java_FireIMSPublicGroupMemberNotify(short far* pPara)
{
    ...
    LOGI(TAG, "rcscontroller java_FireIMSPublicGroupMemberNotify iType[%d] pGroupURI[%s] pOwnerURI[%s] "
    ...
    if(JNI_ERR == iresult || gJinMethod == 0 || gJinMethod == NULL)
    {
        LOGE(TAG, "rcscontroller not found java_FireIMSPublicGroupMemberNotify");
        return;
    }
    ...
    LOGI(TAG, "rcscontroller java_FireIMSPublicGroupMemberNotify over");
}
void java_FireIMSPublicGroupDeleted(LPCTSTR pGroupURI)
{
    ...
    if(JNI_ERR == iresult || gJinMethod == 0 || gJinMethod == NULL)
    {
        LOGE(TAG, "not found java_FireIMSPublicGroupDeleted");
...
void java_FireIMSDeleteMeInPublicGroup(LPCTSTR pGroupURI, int iType)
{
    ...
    LOGI(TAG, "rcscontroller java_FireIMSDeleteMeInPublicGroup pGroupURI[%s] iType[%d]", pGroupURI, iType);

    iresult = getStaticJniMethod((char *)"java_FireIMSDeleteMeInPublicGroup", (char *)"(Ljava/lang/String;I)V", &env, &gJinMethod);

    if(JNI_ERR == iresult || gJinMethod == 0 || gJinMethod == NULL)
    {
        LOGE(TAG, "rcscontroller not found java_FireIMSDeleteMeInPublicGroup");
        return;
    }
...
void java_FireIMSDoPublicGroupInviteResult(long lDoType, LPCTSTR pGroupURI, LPCTSTR pGroupName, LPCTSTR lpcsOwnerName, long lCode)
{
    ...
    if(JNI_ERR == iresult || gJinMethod == 0 || gJinMethod == NULL)
    {
        LOGE(TAG, "not found java_FireIMSDoPublicGroupInviteResult");
...
void java_FireIMSPersonSubInfoChanged(long lType, short far* pPersonSubInfoEvent)
{
    ...
    if(JNI_ERR == iresult || gJinMethod == 0 || gJinMethod == NULL)
    {
        LOGE(TAG, "not found java_FireIMSPersonSubInfoChanged");
...
void java_FireIMSSetUserInfoResult(long lResult)
{
    ...
    if(JNI_ERR == iresult || gJinMethod == 0 || gJinMethod == NULL)
    {
        LOGE(TAG, "not found java_FireIMSSetUserInfoResult");
...
//FireIMSUserInfo
    if(JNI_ERR == iresult || gJinMethod == 0 || gJinMethod == NULL)
    {
        LOGE(TAG, "not found java_FireIMSGotPersonSubInfo");
...
void java_FireIMSSearchUserByDNameResult(LPCTSTR pURI, LPCTSTR pDName, LPCTSTR pSex, int iAge, LPCTSTR pCity, int iOnline)
{
    ...
    if(JNI_ERR == iresult || gJinMethod == 0 || gJinMethod == NULL)
    {
        LOGE(TAG, "not found java_FireIMSSearchUserByDNameResult");
...
void java_FireIMSSearchOneUserOnlineResult(int iPos, LPCTSTR pURI, LPCTSTR pDName, LPCTSTR pSex, int iAge, LPCTSTR pCity)
{
    ...
    if(JNI_ERR == iresult || gJinMethod == 0 || gJinMethod == NULL)
    {
        LOGE(TAG, "not found java_FireIMSSearchOneUserOnlineResult");
...
void java_FireIMSSearchUserByEmailResult(LPCTSTR pURI, LPCTSTR pDName, LPCTSTR pSex, int iAge, LPCTSTR pCity, int iOnline)
{
    ...
    LOGE(TAG, "java_FireIMSSearchUserByEmailResult");
    ...
    if(JNI_ERR == iresult || gJinMethod == 0 || gJinMethod == NULL)
    {
        LOGE(TAG, "not found java_FireIMSSearchUserByEmailResult");
...
void java_FireIMSAddListResult(LPCTSTR pURI, LPCTSTR pName, int iResult)
{
    ...
    if(JNI_ERR == iresult || gJinMethod == 0 || gJinMethod == NULL)
    {
        LOGE(TAG, "not found java_FireIMSAddListResult");
...
void java_FireIMSDelListResult(LPCTSTR pURI, int iResult)
{
    ...
    if(JNI_ERR == iresult || gJinMethod == 0 || gJinMethod == NULL)
    {
        LOGE(TAG, "not found java_FireIMSDelListResult");
...
void  java_FireIMSAddRLSMemberResult(LPCTSTR pURI, LPCTSTR pListMemberURI, int iResult)
{
    ...
    if(JNI_ERR == iresult || gJinMethod == 0 || gJinMethod == NULL)
    {
        LOGE(TAG, "not found java_FireIMSAddRLSMemberResult");
...
void java_FireIMSDeleteRLSMemberResult(LPCTSTR pURI, LPCTSTR pListMemberURI, int iResult)
{
    ...
    if(JNI_ERR == iresult || gJinMethod == 0 || gJinMethod == NULL)
    {
        LOGE(TAG, "not found java_FireIMSDeleteRLSMemberResult");
...
void java_FireIMSSetPresenceRulesResult(LPCTSTR pURI, int iType)
{
    ...
    if(JNI_ERR == iresult || gJinMethod == 0 || gJinMethod == NULL)
    {
        LOGE(TAG, "not found java_FireIMSSetPresenceRulesResult");
...
void java_FireIMSGotOneListInfo(short far* pListInfo, int iReturnCode,LPCTSTR pURI)
{
    ...
    if(JNI_ERR == iresult || gJinMethod == 0 || gJinMethod == NULL)
    {
        LOGE(TAG, "not found java_FireIMSGotOneListInfo");
    ...
    if(pResult == NULL)
    {
        LOGE(TAG, "java_FireIMSGotOneListInfo pResult == NULL so return");
...
void java_FireIMSGotListInfo(List *pListInfo)
{
    ...
    if(JNI_ERR == iresult || gJinMethod == 0 || gJinMethod == NULL)
    {
        LOGE(TAG, "not found java_FireIMSGotListInfo");
	...
	LOGI(TAG, "java_FireIMSGotListInfo to ui");
...
void java_FireCtdCallEvent(long lType, short far* pPara)
{
    ...
    LOGI(TAG, "rcscontroller java_FireCtdCallEvent, lType[%d]", lType);
    ...
    if(lType == CTD_TYPE_STAT || lType == CTD_TYPE_STAT_EX)
    {
        ...
        {
            LOGE(TAG, "rcscontroller java_FireCtdCallEvent, pCtdStatus == NULL");
            return;
        }
    ...
    else if(lType == CTD_TYPE_BIND)
    {
        ...
        {
            LOGE(TAG, "rcscontroller java_FireCtdCallEvent, pCtdBindInfo == NULL");
            return;
        }
    ...
    else if(lType == CTD_TYPE_CALL)
    {
        ...
        {
            LOGE(TAG, "rcscontroller java_FireCtdCallEvent, pCtdCallInfo == NULL");
            return;
        }
    ...
    else if(lType == CTD_TYPE_CTRL)
    {
        ...
        {
            LOGE(TAG, "rcscontroller java_FireCtdCallEvent, pCtdCallCtrlInfo == NULL");
            return;
        }
    ...
    else if(lType == CTD_TYPE_PROC)
    {
        ...
        {
            LOGE(TAG, "rcscontroller java_FireCtdCallEvent, pCtdInCallProcInfo == NULL");
            return;
        }
    ...
    {          
        LOGE(TAG, "rcscontroller java_FireCtdCallEvent unkown lType[%d]", lType);
    }
}
void java_FireDispUICmdForEcp2Result(long lType, short far* pPara)
{
    ...
    if(JNI_ERR == iresult || gJinMethod == 0 || gJinMethod == NULL)
    {
        LOGE(TAG, "not found java_FireDispUICmdForEcp2Result");
    ...
    if(lType == 1)//ReturnCode_Modify_MyPassword
    {
        ...
        {
            LOGE(TAG, "java_FireDispUICmdForEcp2Result pReturnModifyMyPassword == NULL");
            return;
        }
    ...
    else if(lType == 8)
    {
        ...
        {
            LOGE(TAG, "java_FireDispUICmdForEcp2Result pReturnLoginInfo == NULL");
            return;
        }
...
void java_FireIMSDispUICmdResult(long iType, short* pPara)
{
    jmethodID gJinMethod;
    JNIEnv *env;
    int iresult = -1;
    ...
    if(JNI_ERR == iresult || gJinMethod == 0 || gJinMethod == NULL)
    {
        LOGE(TAG, "not found java_FireIMSDispUICmdResult");
    ...
    if (iType == 5)
    {
        ...
        {
            LOGE(TAG, "java_FireIMSDispUICmdResult pImPreStructInfo == NULL");
            return;
        }
           ...
           (pImPreStructInfo->iOperType == 4))
        {
            ...
            {
                LOGE(TAG, "java_FireIMSDispUICmdResult pPersonImRelatedInfo == NULL");
...
//			  env->SetObjectArrayElement(array_TransmitStatus, i, JNI_STR(env,pPersonImRelatedInfo->vTransmitStatus[i]));
        ...
        else if(pImPreStructInfo->iOperType == 5)
        {
            ...
            {
                LOGE(TAG, "java_FireIMSDispUICmdResult pPersonCallInfo == NULL");
        ...
        else if(pImPreStructInfo->iOperType == 6)
        {
            ...
            {
                LOGE(TAG, "rcscontroller java_FireIMSDispUICmdResult pPersonMMCInfo == NULL");
                env->CallStaticVoidMethod(gpostClass, gJinMethod, iType, obj_ImPreStructInfoPara);
                return;
            }

            LOGE(TAG, "rcscontroller java_FireIMSDispUICmdResult, iOperType[%d] iReturnCode[%d] cURI[%s] cAreaCode[%s] "
    ...
    else if (iType == 18)
    {
        ...
        {
            LOGE(TAG, "java_FireIMSDispUICmdResult pGroupClassInfo == NULL");
            return;
        }
    ...
    else if (iType == 20)
    {
        ...
        {
            LOGE(TAG, "java_FireIMSDispUICmdResult pHttpHangUpConfInfo == NULL");
            return;
        }
...
void java_FireIMSCreatePrivateGroupResult(LPCTSTR szGroupName, long iResult)
{
    ...
    if(JNI_ERR == iresult || gJinMethod == 0 || gJinMethod == NULL)
    {
        LOGE(TAG, "not found java_FireIMSCreatePrivateGroupResult");
...
void java_FireIMSModifyPrivateGroupNameResult(LPCTSTR szOldName, LPCTSTR szNewName, long iResult)
{
    ...
    if(JNI_ERR == iresult || gJinMethod == 0 || gJinMethod == NULL)
    {
        LOGE(TAG, "not found java_FireIMSModifyPrivateGroupNameResult");
...
void java_FireIMSDeletePrivateGroupResult(LPCTSTR szGroupName, long iResult)
{
    ...
    if(JNI_ERR == iresult || gJinMethod == 0 || gJinMethod == NULL)
    {
        LOGE(TAG, "not found java_FireIMSDeletePrivateGroupResult");
...
void java_FireIMSGotOnePrivateList(LPCTSTR szGroupName, int iListNum, short far *pListURI)
{
    ...
    if(pMemberInfo == NULL)
    {
        LOGE(TAG, "java_FireIMSGotOnePrivateList pMemberInfo == NULL");
    ...
    if(JNI_ERR == iresult || gJinMethod == 0 || gJinMethod == NULL)
    {
        LOGE(TAG, "not found java_FireIMSGotOnePrivateList");
...
#if 0
        jstr = env->NewStringUTF(pMemberInfo);
...
void java_FireIMSCopyPrivateGroupListResult(LPCTSTR pGroupName, long iGroupType, LPCTSTR pListURI, long iResult)
{
    ...
    if(JNI_ERR == iresult || gJinMethod == 0 || gJinMethod == NULL)
    {
        LOGE(TAG, "not found java_FireIMSCopyPrivateGroupListResult");
...
void java_FireIMSDelPrivateGroupListResult(LPCTSTR pGroupName, LPCTSTR pListURI, long iResult)
{
    ...
    if(JNI_ERR == iresult || gJinMethod == 0 || gJinMethod == NULL)
    {
        LOGE(TAG, "not found java_FireIMSDelPrivateGroupListResult");
...
void java_FireIMSRuleSetEvent(long lType, short far* pPara)
{
    ...
    if(JNI_ERR == iresult || gJinMethod == 0 || gJinMethod == NULL)
    {
        LOGE(TAG, "not found java_FireIMSRuleSetEvent");
    ...
    {
        LOGE(TAG, "java_FireIMSRuleSetEvent pRuleSetEvent == NULL");
...
void java_FireIMSCreateChatRoomResult(LPCTSTR pDlgID, long iResult, LPCTSTR pSubject, LPCTSTR pChatRoomURI)
{
    ...
    if(JNI_ERR == iresult || gJinMethod == 0 || gJinMethod == NULL)
    {
        LOGE(TAG, "not found java_FireIMSCreateChatRoomResult");
...
void java_FireIMSGotChatRoomUserInfo(short *info)
{
    ...
    {
        LOGE(TAG, "java_FireIMSGotChatRoomUserInfo pConInfo == NULL || pUsers == NULL ");
    ...
    if(JNI_ERR == iresult || gJinMethod == 0 || gJinMethod == NULL)
    {
        LOGE(TAG, "not found java_FireIMSGotChatRoomUserInfo");
...
void java_FireIMSInvitedToChatRoom( LPCTSTR pCreaterURI, LPCTSTR pChatRoomURI, LPCTSTR pSubject )
{
    ...
    if(JNI_ERR == iresult || gJinMethod == 0 || gJinMethod == NULL)
    {
        LOGE(TAG, "not found java_FireIMSInvitedToChatRoom");
...
void java_FireIMSLeaveChatRoom( LPCTSTR pChatRoomURI )
{
    ...
    if(JNI_ERR == iresult || gJinMethod == 0 || gJinMethod == NULL)
    {
        LOGE(TAG, "not found java_FireIMSLeaveChatRoom");
...
void java_FireIMSGotDeptAddrListResult( long iType, long iCode, long iNum, short far* pAddrList, LPCTSTR pNodeURI)
{
    ...
    LOGI(TAG, "rcscontroller java_FireIMSGotDeptAddrListResult iType[%d] iCode[%d] pNodeURI[%s]",
    ...
    if(JNI_ERR == iresult || gJinMethod == 0 || gJinMethod == NULL)
    {
        LOGE(TAG, "not found java_FireIMSGotDeptAddrListResult");
	...
	if(iCode != 200)
	{
        LOGE(TAG, "ocx java_FireIMSGotDeptAddrListResult 222 iType[%d] iCode[%d]", iType, iCode);
    ...
    LOGI(TAG, "ocx java_FireIMSGotDeptAddrListResult 111 iType[%d] iCode[%d]", iType, iCode);
...
void java_FireIMSSearchAddrListResult( long iType, long iCode, short far* pAddrList)
{
    ...
    if(JNI_ERR == iresult || gJinMethod == 0 || gJinMethod == NULL)
    {
        LOGE(TAG, "not found java_FireIMSSearchAddrListResult");
...
void java_FireIMSLoadAddrListResult(long iType, long iCode, long iNum, short far* pAddrList)
{
    ...
    if(JNI_ERR == iresult || gJinMethod == 0 || gJinMethod == NULL)
    {
        LOGE(TAG, "not found java_FireIMSLoadAddrListResult");

        return;
    }
    if(iNum > 0 && (pPersonListInfos == NULL))
    {
        LOGE(TAG, "java_FireIMSLoadAddrListResult pPersonListInfos == NULL, iNum=%d", iNum);

        return;
    }
    if((iNum == 0) && (pPersonListInfos == NULL))
    {
        LOGE(TAG, "java_FireIMSLoadAddrListResult pPersonListInfos == NULL, iNum=0");
...
void java_FireIMSDoGroupJoinReqResult(LPCTSTR pGroupURI, LPCTSTR pMemberURI, LPCTSTR pMemberName, long lResult)
{
    ...
    if(JNI_ERR == iresult || gJinMethod == 0 || gJinMethod == NULL)
    {
        LOGE(TAG, "not found java_FireIMSDoGroupJoinReqResult");
...
void java_FireIMSModifyOneListDpNameResult(LPCTSTR pURI, LPCTSTR pDisplayName, int iResult)
{
    ...
    if(JNI_ERR == iresult || gJinMethod == 0 || gJinMethod == NULL)
    {
        LOGE(TAG, "not found java_FireIMSModifyOneListDpNameResult");
...
void java_FireIMSReqJoinPublicGroupResult(LPCTSTR pGroupURI, LPCTSTR pGroupName, long iResult)
{
    ...
    if(JNI_ERR == iresult || gJinMethod == 0 || gJinMethod == NULL)
    {
        LOGE(TAG, "not found java_FireIMSReqJoinPublicGroupResult");
...
void java_FireIMSConfEvent(long iType, long iNum, short far*pConfEvent)
{
    ...
    if (ST_EVENT_ORDER_CONF_NOTIFY == iType)
    {
        ...
        {
            LOGE(TAG, "java_FireIMSConfEvent pOrderConfNotifyPara == NULL");
    ...
    if (GT_EVENT_QUERY_CONF_MEMBERLIST == iType)
    {
        ...
        {
            LOGE(TAG, "java_FireIMSConfEvent pPreConfMemberList == NULL");
...
void java_FireIMSLeavePublicGroupResult(LPCTSTR pGroupName, LPCTSTR pGroupURI, int iResult)
{
    ...
    if(JNI_ERR == iresult || gJinMethod == 0 || gJinMethod == NULL)
    {
        LOGE(TAG, "not found java_FireIMSLeavePublicGroupResult");
...
void java_FireIMSDeletePublicGroupResult(LPCTSTR pGroupURI, long iResult)
{
    ...
    LOGE(TAG, "java_FireIMSDeletePublicGroupResult pGroupURI[%s] iResult[%d]",
             pGroupURI, iResult);
    ...
    if(JNI_ERR == iresult || gJinMethod == 0 || gJinMethod == NULL)
    {
        LOGE(TAG, "not found java_FireIMSDeletePublicGroupResult");
...
void java_FireIMSDelFromMyPuGroupResult(LPCTSTR pSomeoneURI, LPCTSTR pGroupURI, long iResult)
{
    ...
    if(JNI_ERR == iresult || gJinMethod == 0 || gJinMethod == NULL)
    {
        LOGE(TAG, "not found java_FireIMSDelFromMyPuGroupResult");
...
void java_FireMsgIndicationNotify(short far* pPara)
{
    ...
    if(JNI_ERR == iresult || gJinMethod == 0 || gJinMethod == NULL)
    {
        LOGE(TAG, "not found java_FireMsgIndicationNotify");
